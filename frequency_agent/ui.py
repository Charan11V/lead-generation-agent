...
.fx-sim-flag.compact { padding: 8px 10px; margin: 6px 0; }
.fx-sim-dot {
...
.fx-sim-jump {
  ...
  border: 2px solid #c9a227; background: #fff3c4; color: #111;
  font-size: 13px; line-height: 1.45;
}
.fx-sim-jump b { color: #111; }
.fx-sheet-wrap {
